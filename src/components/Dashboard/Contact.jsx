...
import { removeContactUs, selectContactUsById } from "../../app/contactUsSlice";
...
const Contact = () => {
  const { id } = useParams();
  const contact = useSelector((state) => selectContactUsById(state, +id));
    ...
    <>
      ...
      <div className="flex items-center gap-4 justify-center my-6">
        ...
        <Button
          ...
          width="auto"
          customFunc={() => {
            dispatch(removeContactUs(contact.ID));
          }}
